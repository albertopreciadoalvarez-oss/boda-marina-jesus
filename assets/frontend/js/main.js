(function ($) {
    ...
    jQuery(document).ready(function($)
	{
      ...
      $('.member-slider').slick(
        ...
        $(document).on('click', '.footer-tickets', function () 
        {
            var aTag = $("div[id='contacto']");
    ...
    $(window).on('scroll', function () 
    {
       ...
       var ScrollTopTickets = $('.footer-tickets');
       if ($(window).scrollTop() > 1000) 
       {
           ScrollTopTickets.fadeIn(1000);
       } else {
           ScrollTopTickets.fadeOut(1000);
       }
    ...
    $(window).on('load',function()
    {
        ...
        /*-----------------
            Donwload tickets
        ------------------*/
        var footerTickets = $('.footer-tickets')
        footerTickets.fadeOut(); 
